...
reactions = "MAR04388"; % NADP+ [c] + isocitrate [c] ⇒ AKG [c] + CO2 [c] + NADPH [c]
...
%% Find the specific reaction info
...
close all
path_c = pwd;
subfolder = [path_c '\D\swarm_spec\' list_gene];
if ~exist(subfolder, 'dir')
    mkdir(subfolder)
end
...
%define the color for jet. not the manual.
