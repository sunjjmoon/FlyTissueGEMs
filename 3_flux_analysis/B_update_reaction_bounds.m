...
output_folder = 'B_FBA_FVA_rxn_bound_updated';  % Output directory
pathway = pwd;
...
loadfolder = fullfile(pathway, 'A_FBA_FVA');
load(strcat(loadfolder,'\out_all.mat'));
...
save(strcat(subfolder_out, '\out_all_fvaBounded.mat'), 'out_all_fvaBounded');
