...
filteredFolderNames = folderNames(startsWith(folderNames, {'1_', '2_', '3_', '4_', '5_', '6_', '7_', '8_', '9_','10_','11_'}));
...
% print('-dpdf', '-painters', 'Sensitivity_results.pdf');
print(gcf, 'Sensitivity_results.tiff', '-dtiff', '-r300');

t = table(gene_names_ordered_cat_reorder,sens_ordered);
writetable(t, 'Sensitivity_out.xlsx');